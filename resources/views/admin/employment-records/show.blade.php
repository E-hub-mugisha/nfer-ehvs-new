...
<div class="content">
    ...
    $duration = $start
    ? ($end ?? now())->diff($start)->format('%y yrs %m mos')
    : null;
    @endphp
    ...
    <div class="record-hero">
        ...
        <div class="hero-right">
            ...
            <div style="display:flex;align-items:center;gap:6px;justify-content:flex-end;margin-top:10px;">
                ...
                <span style="font-size:12px;font-weight:600;color:var(--red);">{{ $employmentRecord->disputes->count() }} dispute{{ $employmentRecord->disputes->count() > 1 ? 's' : '' }}</span>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="detail-grid">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="max-width:260px;">
                                <div style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12.5px;">
                                    {{ $dispute->description ?? '—' }}
                                </div>
                            </td>
                            <td>
                                <span class="dispute-status {{ $dispute->status }}">
                            ...
                            <td>
                                <a href="{{ route('admin.disputes.show', $dispute->id) }}" style="font-size:12px;color:var(--accent);text-decoration:none;font-weight:500;">View →</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="right-col">
                ...
                <div class="panel-body" style="padding:0;">
                    <ul class="info-list" style="padding:0 20px;">
                        <li>
                            ...
                            <div>
                                <div class="info-list-label">Full Name</div>
                                <div class="info-list-val">{{ optional($emp)->full_name ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <div class="info-list-label">NID</div>
                                <div class="info-list-val" style="font-family:var(--font-mono);">{{ optional($emp)->nid ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.9a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 3h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 10.6a16 16 0 0 0 6 6l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 18z" />
                            </svg>
                            <div>
                                <div class="info-list-label">Phone</div>
                                <div class="info-list-val">{{ optional($emp)->phone ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                ...
                                <div class="info-list-val">{{ optional($emp)->email ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <div class="info-list-label">District / Sector</div>
                                <div class="info-list-val">{{ optional($emp)->district ?? '—' }}{{ optional($emp)->sector ? ', ' . $emp->sector : '' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <div class="info-list-label">Date of Birth</div>
                                <div class="info-list-val" style="font-family:var(--font-mono);">{{ optional($emp)->dob ? \Carbon\Carbon::parse($emp->dob)->format('d M Y') : '—' }}</div>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="panel-body" style="padding:0;">
                    <ul class="info-list" style="padding:0 20px;">
                        <li>
                            ...
                            <div>
                                <div class="info-list-label">Company Name</div>
                                <div class="info-list-val">{{ optional($er)->company_name ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <div class="info-list-label">RDB Number</div>
                                <div class="info-list-val" style="font-family:var(--font-mono);">{{ optional($er)->rdb_number ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <div class="info-list-label">TIN Number</div>
                                <div class="info-list-val" style="font-family:var(--font-mono);">{{ optional($er)->tin_number ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <div class="info-list-label">Email</div>
                                <div class="info-list-val">{{ optional($er)->email ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                ...
                                <div class="info-list-val">{{ optional($er)->address ?? '—' }}</div>
                            </div>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            {{-- Employment History (this employee) --}}
            <div class="panel">
                <div class="panel-header">
                    <div class="panel-title">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            <div class="timeline-title">
                                {{ $h->job_title ?? '—' }}
                                @if($isCurrent)
                                <span class="timeline-current-tag">This record</span>
                                @endif
                            </div>
