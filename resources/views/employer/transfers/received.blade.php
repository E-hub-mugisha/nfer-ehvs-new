...
<div class="container-fluid px-4 py-4">
    <div class="tr-page-header">
        <div class="tr-title-wrap">
            ...
            <div>
                <h5 class="mb-0">Incoming Transfer Requests</h5>
                <div class="tr-subtitle">Review employee transfer requests from other employers</div>
            </div>
        </div>
        @if(!$requests->isEmpty())
                ...
                <table class="table tr-table">
                    ...
                    @foreach($requests as $req)
                        <tr>
                            ...
                            <td>
                                <span class="tr-company">{{ $req->requestingEmployer->company_name }}</span>
                            </td>
                            <td>
                            ...
                            <td>
                                @if($req->isPending())
                                    <div class="tr-actions">
                                        ...
                                        <button class="tr-btn tr-btn-approve"
                                                data-bs-toggle="modal"
                                                data-bs-target="#approveModal{{ $req->id }}">
                                            <i class="bi bi-check-lg"></i> Approve
                                        </button>
                                        <button class="tr-btn tr-btn-reject"
                                                data-bs-toggle="modal"
                                    ...
                                    {{-- Approve Modal --}}
                                    <div class="modal fade tr-modal" id="approveModal{{ $req->id }}" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6>
                                                        <span class="tr-modal-icon approve">
                                                ...
                                                <form action="{{ route('employer.transfer.approve', $req) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <textarea name="rejection_reason"
                                                                  ...
                                                                  placeholder="Let the requesting employer know why..."></textarea>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn-cancel"
                                                                data-bs-dismiss="modal">Cancel</button>
                                                        <button type="submit" class="btn btn-confirm-approve text-white">
                                                            Confirm Approval
                                                        </button>
                                                    </div>
                                                </form>
                                    ...
                                    {{-- Reject Modal --}}
                                    <div class="modal fade tr-modal" id="rejectModal{{ $req->id }}" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6>
                                                        <span class="tr-modal-icon reject">
                                                ...
                                                <form action="{{ route('employer.transfer.reject', $req) }}"
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn-cancel"
                                                                data-bs-dismiss="modal">Cancel</button>
                                                        <button type="submit" class="btn btn-confirm-reject text-white">
                                                            Confirm Rejection
                                                        </button>
                                                    </div>
                                                </form>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="tr-detail-grid">
                                                    <div class="tr-detail-item">
                                                        <span class="tr-detail-item-label">Requested By</span>
                                                        <span class="tr-detail-item-value">{{ $req->requestingEmployer->company_name }}</span>
                                                    </div>
                                                    <div class="tr-detail-item">
                                                    ...
                                                    @endif
                                                    <div class="tr-detail-item">
                                                        <span class="tr-detail-item-label">Submitted</span>
                                                    ...
                                                    <div class="tr-detail-grid">
                                                        ...
                                                        @if(!empty($req->rejection_reason))
                                                            <div class="tr-detail-item full">
                                                                <span class="tr-detail-item-label">Note</span>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                @if($req->isPending())
                                                    <button type="button" class="tr-btn tr-btn-reject"
                                                            data-bs-dismiss="modal"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#rejectModal{{ $req->id }}">
                                                        <i class="bi bi-x-lg"></i> Reject
                                                    </button>
                                                    <button type="button" class="btn btn-confirm-approve text-white"
                                                            data-bs-dismiss="modal"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#approveModal{{ $req->id }}">
                                                        <i class="bi bi-check-lg"></i> Approve
